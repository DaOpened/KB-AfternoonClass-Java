...
public class ListBasic2 {
    ...
    public static void main(String[] args) {
        ...
        // 1. add : 데이터를 삽입하는 메소드
        //
        System.out.println("1. add : 데이터를 삽입하는 메소드");
        intList.add(1);
        intList.add(2);
        intList.add(3);
        ...
        System.out.println("2. addAll : 컬렉션을 모두 추가 시킬때 활용");
        list2.addAll(list); // list에 있던 값이 list2로 모두 추가된다.
        list2.forEach(System.out::println);
        System.out.println("---------------------------------------------------------");

        // 3. add 메소드의 index 활용 방법
        System.out.println("3. add 메소드의 index 활용 방법");
...
//        list.add(12, new Member("TestID9","홍길동9",24, 121212));
        ...
        // 4. size() : 크기를 알아오는 방법
        System.out.println("4. size() : 크기를 알아오는 방법");
        System.out.println(list.size());
        System.out.println(list2.size());
        System.out.println("---------------------------------------------------------");

        // 5. get() : index를 통해 값을 가져오는 방법
        System.out.println("5. get() : index를 통해 값을 가져오는 방법");
        ...
        System.out.println("6. contains : 특정 객체가 list에 존재하는지 확인하는 메소드 (boolean)");
//        Member member1 = list.get(0); // 같은 주소지를 가지는 객체를 주소지로 비교한 사례
        ...
        // index로 삭제
        System.out.println("7. remove : 특정 객체 삭제하는 방법, 삭제 된 객체는 반환!");
        ...
        // 8. clear : 데이터 모두 삭제
        System.out.println("8. clear : 데이터 모두 삭제");
//        list.clear();
//        list = null;
//        list = new ArrayList<>();
        ...
        System.out.println("9. indexOf : 객체에 해당되는 index 반환");
        System.out.println(list.indexOf(member));
        System.out.println("--------------------------------------");

        // 10. isEmpty : 비었는지 확인하는 방법
        System.out.println("10. isEmpty : 비었는지 확인하는 방법");
        System.out.println(list.isEmpty());
        System.out.println(list.size() == 0);
        System.out.println("--------------------------------------");

        // 11. set : 추가가 아닌 교체!! ★
        System.out.println("11. set : 추가가 아닌 교체!! ★");
...
//        setMember.setName("박수정"); // -> 이 상태면 이미 수정된 상태
        ...
        // 12. subList : 자르기 용도
        System.out.println("12. subList : 자르기 용도");
